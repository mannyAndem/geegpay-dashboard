...
const MobileSidebar = ({ expanded }: MobileSidebarProps) => {
  return (
    <div
      ...
      } origin-left transition-all duration-300 ease-out pt-16 fixed top-0 left-0 min-h-screen w-[40vw] flex flex-col justify-between gap-8 bg-veryLightGray border-r border-[#EBECF2] dark:bg-darkGreen dark:border-paleGreen z-30`}
    >
      <div>
